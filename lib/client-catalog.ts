...
export function normalizeProduct(product: DatabaseProduct): Product { return { ...product, category: product.category.slug, image: product.images[0]?.url || "", rating: 5, reviews: 0 }; }
